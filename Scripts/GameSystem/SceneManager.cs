...
public class SceneManager : SingletonMonoBehaviour<SceneManager>
{
    ...
    public string gameeSceneName = "GameeScene";
    public string loadingSceneName = "Loading";
    public string PigBossSceneName = "PigBossScene";

    [Header("Loading Settings")]
    public float minimumLoadingTime = 10f;
    ...
    {
        StartCoroutine(LoadSceneWithLoading(mainMenuSceneName));
    }

    public void LoadGameScene()
    {
        StartCoroutine(LoadSceneWithLoading(gameSceneName));
    }

    public void LoadPigBossScene()
    {
        StartCoroutine(LoadSceneWithLoading(PigBossSceneName));
    }

    public void ReloadCurrentScene()
    {
        StartCoroutine(LoadSceneWithLoading(currentSceneName));
    }
